...
ami<-CMHtest(ami.4, type='cmeans'); ami
...
nort<-CMHtest(nort.4, type='cmeans'); nort
...
imip<-CMHtest(imip.4, type='cmeans'); imip
...
des<-CMHtest(desip.4, type='cmeans'); des
...
clom<-CMHtest(clomip.4, type='cmeans'); clom
...
ven<-CMHtest(venla.4, type='cmeans'); ven
...
dul<-CMHtest(dulox.4, type='cmeans'); dul
...
gaba<-CMHtest(gaba.4, type='cmeans'); gaba
...
preg<-CMHtest(preg.4, type='cmeans'); preg
...
carb<-CMHtest(carba.4, type='cmeans'); carb
...
ox<-CMHtest(oxcarb.4, type='cmeans'); ox
...
valp<-CMHtest(valp.4, type='cmeans'); valp
...
morph<-CMHtest(morph.4, type='cmeans'); morph
...
oxycod<-CMHtest(oxycod.4, type='cmeans'); oxycod
...
meth<-CMHtest(meth.4, type='cmeans'); meth
...
tram<-CMHtest(tram.4, type='cmeans'); tram
...
lido<-CMHtest(lido.4, type='cmeans'); lido
...
income.p<-c(ami$table[,3], nort$table[,3], imip$table[,3], des$table[,3], clom$table[,3],
            ven$table[,3], dul$table[,3], gaba$table[,3], preg$table[,3], carb$table[,3],
            ox$table[,3], morph$table[,3], oxycod$table[,3], meth$table[,3], tram$table[,3],
            lido$table[,3]); income.p
